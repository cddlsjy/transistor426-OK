...
//        }
        ...
        preferenceRemoteAutoPlay.title = getString(R.string.pref_remote_auto_play_title)
        preferenceRemoteAutoPlay.setIcon(R.drawable.ic_play_circle_outline_24dp)
        preferenceRemoteAutoPlay.key = Keys.PREF_REMOTE_AUTO_PLAY
        preferenceRemoteAutoPlay.summaryOn = getString(R.string.pref_remote_auto_play_summary_enabled)
        preferenceRemoteAutoPlay.summaryOff = getString(R.string.pref_remote_auto_play_summary_disabled)
        preferenceRemoteAutoPlay.setDefaultValue(PreferencesHelper.loadRemoteAutoPlay())


        // set up "Auto Start on Boot" preference
        val preferenceAutoStartOnBoot: SwitchPreferenceCompat = SwitchPreferenceCompat(activity as Context)
        preferenceAutoStartOnBoot.title = getString(R.string.pref_auto_start_on_boot_title)
        preferenceAutoStartOnBoot.setIcon(R.drawable.ic_play_circle_outline_24dp)
        preferenceAutoStartOnBoot.key = Keys.PREF_AUTO_START_ON_BOOT
        preferenceAutoStartOnBoot.summaryOn = getString(R.string.pref_auto_start_on_boot_summary_enabled)
        preferenceAutoStartOnBoot.summaryOff = getString(R.string.pref_auto_start_on_boot_summary_disabled)
        preferenceAutoStartOnBoot.setDefaultValue(PreferencesHelper.loadAutoStartOnBoot())
        ...
        preferenceCategoryGeneral.contains(preferenceRemoteAutoPlay)
        preferenceCategoryGeneral.contains(preferenceAutoStartOnBoot)
...
//        preferenceCategoryMaintenance.contains(preferenceUpdateCollection)
        ...
        screen.addPreference(preferenceAutoStartOnBoot)
