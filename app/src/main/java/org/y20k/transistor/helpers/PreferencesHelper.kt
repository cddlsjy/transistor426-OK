...
object PreferencesHelper {
    ...
    /* Loads remote auto play setting */
    fun loadRemoteAutoPlay(): Boolean {
        return sharedPreferences.getBoolean(Keys.PREF_REMOTE_AUTO_PLAY, true)
    }


    /* Saves remote auto play setting */
    fun saveRemoteAutoPlay(enabled: Boolean) {
        sharedPreferences.edit {
            putBoolean(Keys.PREF_REMOTE_AUTO_PLAY, enabled)
        }
    }


    /* Loads auto start on boot setting */
    fun loadAutoStartOnBoot(): Boolean {
        return sharedPreferences.getBoolean(Keys.PREF_AUTO_START_ON_BOOT, false)
    }


    /* Saves auto start on boot setting */
    fun saveAutoStartOnBoot(enabled: Boolean) {
        sharedPreferences.edit {
            putBoolean(Keys.PREF_AUTO_START_ON_BOOT, enabled)
        }
    }
